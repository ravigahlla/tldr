...
def summarize_text_chunks(chunks: list, client: openai.OpenAI, model_to_use: str, system_prompt: str, user_prompt_template: str, initial_context: str = ""):
    ...
    for i, chunk in enumerate(chunks):
        ...
        current_user_prompt = (
            ...
            f"Then, provide a 'Detailed Analysis and Contextual Summary' section. This section should be comprehensive and insightful. It must:\n"
            f"  - Clearly articulate the article's main arguments, thesis, and key takeaways.\n"
            f"  - Explain any crucial concepts, terminology, or jargon in simple, understandable terms, providing necessary context for a reader who may not be deeply familiar with the topic.\n"
            f"  - Offer insightful analysis: What are the broader implications or significance of the article's points? How does this connect to other trends or relevant information? Are there any noteworthy nuances, underlying assumptions, or potential counter-arguments mentioned or implied in the text?\n"
            f"  - Be well-structured and flow logically, not just a list of points. Subheadings within this section are encouraged for clarity if the analysis is extensive.\n"
            f"This 'Detailed Analysis and Contextual Summary' section is the core of your output. {prompt_focus}\n"
